...
sm.regression(y=lgWeight,x=Yr,h=.3, eval.points = Yr)
...
print(h.dpill)
```
As one can see this in much larger then the bandtwidth used in the test and we will see that this results in a muhc smoother graph. 
...
Fit a new model with hte residuals on the y axis. 
