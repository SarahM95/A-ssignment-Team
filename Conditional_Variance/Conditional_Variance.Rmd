...
h.dpill_q<- dpill(Yr, z, gridsize = 101, range.x = range(Yr)) #it produces a Nan value!!!!!! I dont know why

h_q<- h.k.fold.cv(Yr, z) 

h_q_opt_index<- which.min(h_q$k.cv)
h_q_opt <- h_q$h.v[h_q_opt_index]

q_hat_sm <- sm.regression(x = Yr, y = z, h= h_q_opt, eval.points = Yr)
