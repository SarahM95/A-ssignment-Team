...
```{r}
#How about doing this to solve na? it sets na to col average
library(zoo)
...
```{r}
#NOT SURE IF THIS IS A GOOD IDEA IT DELETES THE ENTIRE ROW.. 
data1 <- na.omit(data)
c1 <- cor(data1)
summary(c1)
```
...
#I agree, na.aggregate is probably better :) 
