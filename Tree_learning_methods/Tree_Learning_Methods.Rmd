...
#Queation: Why is it relevant for us to know that a lot of the parameters has similar means? It is not really saying that they have similar means it's saying that they behave similar, it's like a way to plot the correlations computed before.
...
>>>>>>> 28d9860e98ffcd3e0309d45cdc1668f51409ecce
...
# It's not working in my computer
k <- 0
for (i in treeDepth) {
  k = k +1
