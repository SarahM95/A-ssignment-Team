...
In this plots it can be seen that there is a lot of variables that don't contribut much on this principal components. For knowing which variables are the ones that don't contribute much on the principal components.
...
l$sign <- l$t < 0.5 # I assume that if the contribution in the sum of the three mean principal components is not higher than 0.05 the variable is not important for data variation.
