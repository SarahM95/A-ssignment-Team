...
# 
# 
spam <- read.table("Discriminant_Rules/spam_email_database/spambase.data",sep=",")

spam.names <- c(read.table("Discriminant_Rules/spam_email_database/spambase.names",sep=":",skip=33,nrows=53,as.is=TRUE)[,1],
                "char_freq_#",
                read.table("Discriminant_Rules/spam_email_database/spambase.names",sep=":",skip=87,nrows=3,as.is=TRUE)[,1],
                "spam.01")
