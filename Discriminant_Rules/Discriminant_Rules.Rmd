...
##SHOULD WE NOT SHUFFEL THE DATA BEFORE STARTING TO WORK WITH THEM OR DOESNT IT MATTER? It doesnt matter, sample selects ransomly.
```
...
#### WHY DO WE USE THE DEFAULT K= 1, what would you use instead? It wasn´t specified in the question, so the default should be fine.
