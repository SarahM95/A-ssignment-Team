...
##SHOULD WE NOT SHUFFEL THE DATA BEFORE STARTING TO WORK WITH THEM OR DOESNT IT MATTER? 
```
...
```{r}
#alternative for knn
knn_clas <- ifelse(knn_classification == "1", 0, 1) #WHY DOES IT NOT MATTER WHAT I SET TO 1 AND WHAT TO 0? 
#knn_clas
#spam_test$spam.01
...
```{r}
plot(ML_glm_performance, col = "red")
plot(Lasso_glmnet_performance, add = TRUE, col = "green")
plot(knn_roc, add = TRUE, col = "black")
legend(x="bottomleft", legend("GLM", "GLMNET", "KNN"), col = c("red", "green", "black"))
```
