...
plot(ridge_boston)
```
As one can see rigde regression has a lot more non-zero expenatory variables than Lasso. However a lot of them are very close to zero. The one with the larges beta coefficients are the same as for Lasso namely $TAX$ and $B$. 
